  ...
  >
    ...
    <template #content>
      <div class="tw:p-3 tw:pt-2">
        <div
          class="tw:text-base tw:font-bold tw:text-gray-900 dark:tw:text-slate-100 tw:leading-6 tw:mb-1 tw:line-clamp-2"
        >
          <span class="tw:text-gray-700 dark:tw:text-slate-300">{{ typeLabel }}:</span>
